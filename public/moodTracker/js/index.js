...
const renderTasks = (taskHolder) => {
    ...
    getTasks().forEach((taskData, i) => {
        ...
        icon.src = "moodTracker/img/icons/icon" + num + ".png";
...
const initHome = () => {
    ...
    umbrellaCat.src = "moodTracker/img/cat-umbrella.png";
...
const initArticle = (article) => {
    ...
    crossImg.src = "moodTracker/img/cross.webp";
...
const initTest = () => {
    ...
    articles.forEach(article => {
        ...
        api.src = "moodTracker/img/articles/" + article.picname + ".jpg";
...
const initNavigation = () => {
    ...
    buttons.forEach((button, i) => {
        ...
        navIcon.src = "moodTracker/img/nav-icons/" + button + ".png";
...
const initModalWindow = () => {
    ...
    ['bad', 'neutral', 'good'].forEach(name => {
        ...
        emoteImage.src = "moodTracker/img/emotions/" + name + ".png";
...
const initProfile = (username) => {
    ...
    picture.setAttribute('src', 'moodTracker/img/' + userGender + '.png');
    ...
    if (username !== "Who are you?") {
        ...
        addMoodImage.setAttribute("src", "moodTracker/img/calendar.png");
...
const initWelcomePage = () => {
    ...
    registerButton.addEventListener("click", () => {
        ...
        fetch("http://localhost:3000/moodData", {
            method: "POST",
